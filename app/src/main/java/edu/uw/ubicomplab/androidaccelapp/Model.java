...
public class Model {
    ...
    public String[] outputClasses = {"right", "faceDown", "flicker"};
...
/*        featureNames.put("Feature4", "numeric");
    ...
    public void addSample(DescriptiveStatistics atime, DescriptiveStatistics ax, DescriptiveStatistics ay, DescriptiveStatistics az,
        ...
        double maxDataAx = ax.getMax();
        //double minDatax = ax.getMin();
        double maxDataAy = ay.getMax();
        //double minDatay = ay.getMin();
        double maxDataAz = az.getMax();

        data[0] = maxDataAx;//feature arary
        data[1] = maxDataAy;
        data[2] = maxDataAz;
